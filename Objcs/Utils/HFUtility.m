...
+ (UIImage *)whiteImageWithName:(NSString *)imageName  Whiteness:(int)whiteness {
    ...
    return [HFUtility whiteImage:[UIImage imageNamed:imageName] Whiteness:whiteness];
}
...
+ (UIImage *)imageToGraryWithImageName:(NSString *)imageName {
    return [HFUtility imageToGraryWithImage:[UIImage imageNamed:imageName]];
}
