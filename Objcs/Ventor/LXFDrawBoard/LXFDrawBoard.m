...
@property(nonatomic,assign)BOOL bIsDirty;
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(touchesBeganWithLXFDrawBoard:)]) {
        [self.delegate touchesBeganWithLXFDrawBoard:self];
    }
}
...
- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(touchesMovedWithLXFDrawBoard:)]) {
        [self.delegate touchesMovedWithLXFDrawBoard:self];
    }
...
- (void)drawImage {
    ...
    if (self.drawStatus==LXFDrawStatusEnd&&self.bIsDirty) {
