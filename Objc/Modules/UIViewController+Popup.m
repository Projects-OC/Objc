...
- (void)presentPopupViewController:(UIViewController *)viewControllerToPresent animated:(BOOL)flag completion:(void (^)(void))completion {
    if (self.popupViewController == nil) {
        ...
        if (self.useBlurForPopup) {
            ...
            UITapGestureRecognizer*  tapGrForCloseKeyBoard = [[UITapGestureRecognizer alloc] init];
            tapGrForCloseKeyBoard.cancelsTouchesInView = NO;
            [tapGrForCloseKeyBoard addTarget:self action:@selector(tapViewDismiss)];

            [fadeView addGestureRecognizer:tapGrForCloseKeyBoard];
...
- (void)dismissPopupViewControllerAnimated:(BOOL)flag completion:(void (^)(void))completion {
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"YPopupDissMiss" object:nil];
    // remove observer
