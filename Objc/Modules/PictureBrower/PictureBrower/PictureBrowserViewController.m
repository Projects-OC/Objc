...
@interface PictureBrowserViewController ()<UICollectionViewDataSource, UICollectionViewDelegateFlowLayout,UICollectionViewDelegate, PictureBrowserCellDelegate>
...
- (void)viewDidLoad {
    ...
    //指定对应图片
    [self.collectionView scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:self.animatedTransition.transitionParameter.transitionImgIndex inSection:0]
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[PictureBrowserCell class]
            forCellWithReuseIdentifier:NSStringFromClass([PictureBrowserCell class])];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    PictureBrowserCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([PictureBrowserCell class]) forIndexPath:indexPath];
...
- (void)setupBaseViewControllerProperty:(NSInteger)cellIndex{
    ...
    PictureBrowserCell *cell = (PictureBrowserCell *)[_collectionView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:cellIndex inSection:0]];
